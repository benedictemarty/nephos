...
Référentiel SKOS de métadonnées météorologiques, **désormais positionné comme couche sémantique d'une plateforme SI météo gouvernée Po-scale**. Vision détaillée dans [`docs/architecture/`](docs/architecture/).

Voir [ADR 0001](docs/adr/0001-adopter-skos-comme-socle-du-referentiel.md) (SKOS) et [ADR 0002](docs/adr/0002-python-comme-stack-dimplementation.md) (Python) pour le socle. ADRs 0006 à 0019 (cible plateforme) à rédiger après confirmation sponsor / scope / budget / équipe.

## Réalignement (2026-05)

| EPIC | Statut | Position dans la cible plateforme |
|------|--------|-----------------------------------|
| E1 — Gouvernance architecturale et documentaire | ✅ majoritairement fait | Conserve la valeur, à enrichir d'ADRs 0006-0019 |
| E2 — Refonte schéma SQL SKOS | ✅ fait | Couche sémantique structurée, à enrichir avec catalogue technique en E11 |
| E3 — Bootstrap projet Python | ✅ fait | Squelette applicatif de la couche sémantique |
| E4 — Pipeline d'import sources standards | ✅ majoritairement fait | Connecteurs sémantiques mutualisables (capacité « Acquérir » de la cible) |
| E5 — Validation et qualité sémantique | ✅ fait | Couche qualité de la sémantique |
| E6 — Export et interopérabilité | ✅ partiellement | Diffusion sémantique, à étendre vers STAC + Iceberg en E12 |
| E7 — Façade API | 📋 ouvert | Couche service, alignée à la cible |
| E8 — Curation et publication | 📋 ouvert | Capacité « Saisir » (aspect curation) |
| E9 — Opération et observabilité | 📋 ouvert | Capacité « Surveiller » de la cible |
| E10 — Outils de validation de fichiers | 📋 ouvert | Service consumer de la sémantique |
| **E11 — Catalogue technique Iceberg + Lakekeeper** | 📋 nouveau | Capacité « Cataloguer » + « Stocker » |
| **E12 — Stockage objet + format gridded Zarr** | 📋 nouveau | Capacité « Stocker » (gridded Po-scale) |
| **E13 — Orchestration (Dagster ou Kestra)** | 📋 nouveau | Capacités « Acquérir » + « Calculer » + « Évoluer » |
| **E14 — Data contracts gouvernance** | 📋 nouveau | Capacité « Gouverner » transverse |
| **E15 — Alerting métier (annexe A)** | 📋 nouveau | Capacité « Surveiller » + service consumer |
| **E16 — SLA fraîcheur + complétude (annexes B, C)** | 📋 nouveau | Capacité « Surveiller » |
| **E17 — Habilitations classifiées L0-L3 (annexe H)** | 📋 nouveau | Capacité « Habiliter » |
| **E18 — Saisie opérateur DataWindow (annexe F)** | 📋 nouveau | Capacité « Saisir » |
| **E19 — Modification append-only (annexe G)** | 📋 nouveau | Capacité « Évoluer » + traçabilité |
...
## EPIC 11 — Catalogue technique (Iceberg + Lakekeeper)
...
## EPIC 12 — Stockage objet et format gridded (Zarr)
...
## EPIC 13 — Orchestration (Dagster ou Kestra)
...
## EPIC 14 — Data contracts (gouvernance par construction)
...
## EPIC 16 — Fraîcheur SLA + complétude
...
## EPIC 17 — Habilitations classifiées L0-L3
...
## EPIC 18 — Saisie opérateur (DataWindow)
...
## EPIC 19 — Modifications append-only (event sourcing)
